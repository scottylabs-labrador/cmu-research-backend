...
url_users = "https://scholars.cmu.edu/api/users"
...
response_users = requests.request("POST", url_users, headers=headers, data=payload)
...
for j in data_dict["resource"]:
  ...
  url = f"https://scholars.cmu.edu/api/users/{iD}"

  payload = {}
  headers = {
    'Accept-Language': 'en-US,en;q=0.9,zh-CN;q=0.8,zh;q=0.7',
    'Connection': 'keep-alive',
    'If-None-Match': 'W/"5995-RVttvUjvQTz2Gv/GWS3UfPaXfcw"',
